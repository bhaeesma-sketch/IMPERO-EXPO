...
// Hero Images - Expanded Collection for "First Look" Appeal
...
import heroImg5 from '@assets/generated_images/close_up_of_master_jeweler_setting_a_diamond.png';
...
const heroImages = [heroImg2, heroImg4, heroImg1, heroImg3, heroImg5];
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-primary/20 overflow-x-hidden">
      <LiveTicker />
      <Header />
      {/* Hero Section - Redesigned for Impact with Image Slider & Ken Burns Effect */}
      <section className="relative min-h-screen flex items-center overflow-hidden pt-20 bg-black">
        ...
        {/* Animated Particles/Texture Overlay */}
        ...
        <div className="container relative z-10 px-4 grid lg:grid-cols-12 gap-12 items-center h-full">
          ...
          >
            ...
            <h1 className="font-serif text-5xl md:text-8xl font-medium leading-[1.05] tracking-tight">
              ...
              <span className="block overflow-hidden">
                <motion.span
                  ...
                  className="block italic pb-2 bg-clip-text text-transparent bg-gradient-to-r from-[#BF953F] via-[#FCF6BA] to-[#B38728] drop-shadow-lg filter drop-shadow(0 0 20px rgba(191, 149, 63, 0.3))"
                >
                  Golds & Diamonds
                </motion.span>
              </span>
            ...
            <Reveal delay={0.8} direction="up">
              <div className="flex flex-wrap justify-center gap-4 pt-8">
                <Link href="/catalog">
                  <Button className="h-14 px-10 bg-gradient-to-r from-[#BF953F] to-[#AA771C] hover:from-[#d4a849] hover:to-[#b38023] text-white border-0 rounded-sm font-medium tracking-wide shadow-[0_0_20px_rgba(191,149,63,0.3)] hover:shadow-[0_0_30px_rgba(191,149,63,0.5)] transition-all duration-300 transform hover:-translate-y-1">
                    View Catalog
                  </Button>
                </Link>
                <Link href="/bespoke">
                  <Button variant="outline" className="h-14 px-10 border-white/30 bg-white/5 backdrop-blur-sm text-white hover:bg-white hover:text-black hover:border-white rounded-sm font-medium tracking-wide transition-all duration-300">
                    Bespoke Jewelry
                  </Button>
                </Link>
              </div>
        ...
        >
          ...
          <div className="w-[1px] h-12 bg-gradient-to-b from-white/50 to-transparent overflow-hidden">
            <motion.div
              ...
              className="w-full h-full bg-[#BF953F]"
            />
          </div>
        </motion.div>
      </section>
